...
Screen {
	...
	property int leftShift : isNxt ? 160:128
	...
	Text {id: head4 ; anchors.top : head1.top ; anchors.left: parent.left ; anchors.leftMargin:left4; visible: (tileArray[0][0]).length>0;font.pixelSize: textSize; font.family: fontName; text:"%" }
